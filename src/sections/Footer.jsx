...
export const Footer = ({ footerImage, children }) => {
  return (
    ...
    <footer className='relative w-full lg:-mt-52 '>
      <div className="absolute right-0  left-0 ">
        <div className="lg:absolute lg:top-1/2 lg:left-1/2 lg:-translate-y-1/2 lg:-translate-x-1/2 w-full">
          <div className="container px-9 w-full">
            {children}
          </div>
        </div>

        {/* Add grid below the box */}
        <div className="absolute bottom-[27%] lg:bottom-1/3  translate-y-2/3  w-full">
          <div className=" container w-full mt-28">
            <div className="grid grid-cols-1 sm:grid-cols-4 md:grid-cols-3 lg:grid-cols-4 gap-3 lg:gap-8 lg:text-center">
              <div>
                <nav className='flex flex-col gap-3'>
                  <a href="" className='font-roboto text-sm'>Products</a>
                  <a href="" className='font-roboto text-sm'>Projects</a>
                  <a href="" className='font-roboto text-sm'>Students</a>
                  <a href="" className='font-roboto text-sm'>Coaches</a>
              ...
              <div className='col-span-3 lg:col-span-1'     >
                <nav className='flex flex-col justify-start items-start gap-3'>
                  ...
                  <div className='flex lg:flex-col gap-2'>
                    <button className='border-2 mt-4 w-max flex-shrink-0 text-xs h-10 lg:h-auto border-white/90 rounded-full font-poppins px-4 py-1 lg:py-2'>Download App</button>
                    <button className='inline-flex  gap-4 items-center justify-center py-3 rounded-md bg-gradient-to-t px-3 w-max lg:w-full mt-3  from-[#814E00] to-[#C07F00] flex-shrink-0'> <span className='font-poppins font-extrabold uppercase text-xs lg:text-lg'>Connect Wallet</span> <TiPlus className='size-7 hidden lg:block font-extrabold' /> </button>
                  </div>
                </nav>
              </div>

              <div className='order-2 lg:order-1 mt-auto lg:mt-0 mb-24 lg:mb-0 col-span-2 lg:col-span-1' >
                <h1 className='font-roboto font-bold tracking-widest uppercase text-xs lg:text-sm text-start '>Stay Connected</h1>
                <div className='flex gap-3 lg:gap-8 mt-4'>
                  <a href="" className='bg-white flex-shrink-0 rounded-full size-10 flex justify-center items-center'><svg className='size-9' width="44" height="45" viewBox="0 0 44 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a href="" className='bg-white  flex-shrink-0 rounded-full size-10 flex justify-center items-center' ><svg className='size-7' width="44" height="45" viewBox="0 0 44 45" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className='lg:me-10 order-1 lg:order-2 col-span-2 lg:col-span-1 '>
                <div className='flex flex-col lg:items-end gap-3 lg:justify-end'>
                  ...
                  <small className='font-roboto text-[10px] tracking-widest  mt-5 '>© 2023 Hasana. All rights reserved.</small>
                  <ul className='flex gap-3 lg:justify-end lg:items-end w-full'>
        ...
        >
          <mask
            ...
            height="869"
          >
            <path d="M614 0H0V868.801H614V0Z" fill="white" />
          </mask>
          <g mask="url(#mask0_0_1)">
            <path
              opacity="0.25"
              d="M441.441 359.96C441.441 359.96 429.493 422.633 397.456 382.094C365.418 341.554 362.775 300.083 301.343 339.923C239.911 379.764 217.601 377.434 204.384 331.769C191.168 286.104 166.426 222.499 114.087 229.256C61.643 236.012 34.6807 79.6793 -3.06653 54.284C-40.9195 28.8886 -68.3047 107.172 -68.3047 107.172V912.134H638.001C638.001 912.134 619.921 789.118 579.425 751.608C538.928 714.097 544.744 688.935 540.937 626.029C537.237 563.356 459.416 520.953 464.808 428.924C470.307 336.662 441.441 359.96 441.441 359.96Z"
          ...
          <g mask="url(#mask1_0_1)">
            <path
              opacity="0.25"
              d="M-56.0377 119.053C-51.7026 112.995 24.9548 72.4559 49.0623 186.619C73.1698 300.781 98.7575 302.179 137.351 309.169C176.049 316.158 164.313 317.556 207.452 378.831C250.592 440.106 275.863 408.187 307.266 386.287C338.669 364.386 388.787 416.808 428.755 371.143C468.828 325.478 470.414 400.499 470.414 400.499C470.414 400.499 459.312 465.734 491.667 511.633C524.021 557.298 508.161 609.952 517.149 693.594C526.136 777.235 613.896 901.183 613.896 901.183L-72.1094 822.434L-56.0377 119.053Z"
          ...
          <path
            d="M-45.8926 142.355C-45.8926 142.355 -33.3102 271.429 19.7685 285.874C72.8472 300.319 74.5389 296.126 94.7342 354.838C115.035 413.783 125.926 446.634 162.087 425.432C198.248 404.231 229.969 353.906 259.574 394.678C289.18 435.451 354.629 504.647 422.194 344.12C489.758 183.594 467.554 425.432 467.554 425.432C467.554 425.432 420.714 515.364 489.018 595.977C513.125 626.032 509.213 716.197 517.143 774.444C525.073 832.69 589.994 945.455 589.994 945.455C589.994 945.455 92.7252 1036.55 89.4475 1037.72C86.1697 1038.88 -99.5 813.119 -99.5 813.119L-45.8926 142.355Z"
