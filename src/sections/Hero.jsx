        ...
        <div>
            <div className="container  h-[80vh] flex items-center ">
                <div className='max-w-lg text-white '>
                    <h2 className='font-poppins font-bold text-[2.20rem]'>Nurturing Faith Through Technology.</h2>
                    <h1 className='font-monoton text-[4.9rem]'>Features</h1>
                    <h2 className='font-poppins font-thin text-6xl uppercase -mt-4'>of Hasanat</h2>
