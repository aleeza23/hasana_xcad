...
export const RightTimelineItem = ({ item, className }) => {
    ...
    return (
        <div className={` lg:flex pt-12 lg:pt-0 lg:gap-0 lg:flex-row lg:items-center justify-end ms-auto ${item.number !== 1 && className} `}>
            {/* Dot */}
            ...
            <div className="absolute left-[48%] lg:left-[58%] -rotate-180 -translate-x-1/2">
                <svg
                    width="175"
                    height="18"
                    viewBox="0 0 175 18"
                    ...
                    className='size-36 lg:size-[175px]'
                >
                    <path
                ...
                <p className="absolute right-[-5%] top-1/2 rotate-180 -translate-y-1/2 w-full translate-x-1/2 gradient-text font-bold">
                    {quarter}
                </p>
            </div>
